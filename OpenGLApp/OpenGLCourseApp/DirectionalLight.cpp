									...
									GLfloat xDir, GLfloat yDir, GLfloat zDir) : Light(shadowWidth,shadowHeight,red,green,blue,aIntensity,dIntensity)
{
	...
	lightProj = glm::ortho(-20.0f, 20.0f, -20.0f, 20.0f, 0.1f, 100.0f);
						//	right left	bottom	top	  near farplane
...
{
	return lightProj*glm::lookAt(-direction,glm::vec3(0.0f,0.0f,0.0f),glm::vec3(0.0f,1.0f,0.0f));//lightproj is projection and view combined
}
